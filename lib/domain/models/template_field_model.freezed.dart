    ...
    return _then(_value.copyWith(
      ...
      type: null == type
          ...
          : type // ignore: cast_nullable_to_non_nullable
              as FieldType,
      excelColumn: null == excelColumn
          ? _value.excelColumn
          : excelColumn // ignore: cast_nullable_to_non_nullable
              as String,
      x: null == x
          ? _value.x
...
// ARGB
  ...
  @override
  String toString() {
    return 'TemplateField(id: $id, type: $type, excelColumn: $excelColumn, x: $x, y: $y, width: $width, height: $height, fontFamily: $fontFamily, fontSize: $fontSize, color: $color, align: $align)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.excelColumn, excelColumn) ||
                other.excelColumn == excelColumn) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, type, excelColumn, x, y,
      width, height, fontFamily, fontSize, color, align);
...
abstract class _TemplateField implements TemplateField {
  const factory _TemplateField(
      ...
      required final String excelColumn,
      ...
      final double? fontSize,
      final int? color,
      final TextAlign? align}) = _$TemplateFieldImpl;
